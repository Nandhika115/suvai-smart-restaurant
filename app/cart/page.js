...
export default function CartPage() {
  ...
  async function placeOrder() {
    ...
    router.push(
      `/payment?orderId=${data.order.id}&total=${data.order.total}`
    );
          ...
          <>
            ...
            <div className="ticket-edge mt-8 rounded-ticket border border-char-700 bg-char-850 p-6 pt-8 font-mono">
              ...
              {items.map((line) => (
                ...
                <div
                  key={line.menuId}
                  className="flex items-center justify-between border-b border-dashed border-char-700 py-3"
                >


                  <div>

                    <p className="text-char-50">
                      {line.name}
                    </p>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      onClick={() =>
                        updateQty(line.menuId, line.qty - 1)
                      }

                      className="focus-ring h-7 w-7 rounded-ticket border border-char-600 text-char-100"
                    ...
                    <span className="w-6 text-center text-char-50">
                      {line.qty}
                    </span>
              ...
              <div className="flex items-center justify-between pt-4">
                ...
                <span className="text-char-200">
                  Total
                </span>


                <span className="text-lg text-saffron-400">
                  ₹{total}
                </span>
            ...
            {error && (
              ...
              <p className="mt-3 text-sm text-chili-400">
                {error}
              </p>
